...
{
public:
	static T& Min(const T& v1, const T& v2) { return v1<v2? v1 : v2; }
	static T& Max(const T& v1, const T& v2) { return v1>v2? v1 : v2; }
	static T& Clip(const T& min, const T& v, const T& max) { return Max(min,Min(v,max)); }
};
